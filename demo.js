...
const myContract = new web3.eth.Contract(abi, "0x1A84E71e8B0CD3Fd5C7cFe6DC4ADA8AEC22B47CC");
myContract.getPastEvents('Transfer', {
    ...
    result.forEach(item => {
        ...
        if(returnValues["to"].toLowerCase() == "0x35F038b54F05e7b48C9a8B9214950F3494a5D9b2"){
            tokenIds.push(tokenID);
        }
        if(returnValues["from"] == "0x35F038b54F05e7b48C9a8B9214950F3494a5D9b2"){
            tokenIds.map((val, i) => {
                if(val === tokenID){
                    tokenIds.splice(i, 1);
                }
